...
if(isset($_POST['btn'])){
    $mycon=new specialitemController();
...
<div class="container">
    <div class="row main">
        <div class="main-login main-center">
            <h5>Add New Item</h5>
            <form class="" method="post" action="addspecialitem.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="description"   placeholder="Enter your Short Description" required/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="confirm" class="cols-sm-2 control-label">Item images</label>
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-image-o" aria-hidden="true"></i></i></span>
                            <input type="file" class="form-control" name="image" placeholder="Insert your Item images" required/>
                        </div>
                    </div>
                </div>
