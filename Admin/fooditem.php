 ...
 <div class="container" align="center">
     <div class="row col-md-6 col-md-offset-2 custyle">
            <table class="table table-striped custab">
                <thead>
                <a href="insertitem.php" class="btn btn-primary btn-xs pull-right"><b>+</b> Insert new Item</a>
                <tr>
                    <th>ID</th>
                ...
                <tr>
                    ...
                    <td class="text-center"><a class='btn btn-info btn-xs' href="edititem.php?id=<?php echo $all_info['Id']; ?>"><span class="glyphicon glyphicon-edit"></span> Edit</a> <a href="?delete=<?php echo $all_info['Id']; ?> "class=" btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a></td>
                </tr>
                <?php } ?>
            </table>
        </div>
