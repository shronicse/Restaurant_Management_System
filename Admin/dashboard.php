...
<section id="container">
    ...
    <header class="header fixed-top clearfix">
        ...
        <div class="brand">
            ...
            <button class="btn btn-success"><?php echo $message; ?></h3></button>
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="username"><?php $username; ?></span>
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu extended logout">
                        <li><a href="registration.php"><i class=" fa fa-suitcase"></i>Add Admin</a></li>
        ...
        <div id="sidebar" class="nav-collapse">
            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li>
                        <a href="addspecialitem.php">
                            <i class="icon-heart"></i> <i class="icon-food"></i>
                            <span>Insert Special Food Item </span>
                        </a>
                    </li>
                    <li>
                        <a href="allspecialitem.php">
                            <i class="icon-heart"></i><i class="icon-food"></i>
                            <span>All Special Food Item </span>
                        </a>
                    <li>
                        <a href="allreservation.php">
                            <i class="icon-food"></i>
                            <span>All reservation food </span>
                        </a>
                    </li>
    ...
    <section id="main-content">
        ...
        <div class="footer">
            <div class="wthree-copyright">
                <p>© 2018 Visitors. All rights reserved | Design by <a href="#">Shamsul huda Roni</a></p>
            </div>
        </div>
        <!-- / footer -->
    </section>
