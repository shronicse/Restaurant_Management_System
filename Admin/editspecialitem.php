...
<div class="container">
    <div class="row main">
        <div class="main-login main-center">
            <h5>Add New Item</h5>
            <form  action="special_item_edit_handler.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="file" class="form-control" name="img" id="img"  value=" <?php echo $result['Img'];?> " />
                        </div>
                    </div>
                </div>
